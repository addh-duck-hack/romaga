...
- **API contract**: `backend/openapi.yaml` documents the REST surface; `backend/romaga-postman-collection.json` is a matching Postman collection. Update both when changing routes/payloads.
